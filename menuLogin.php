        ...
        <div class="row">
            <div class="col-md-2 col-sm-2 col-xs-2">
                <div id="sidebar-container" class="bg-primary">
                    <div class="menu">
                        <a href="" class="d-block text-light p-3">Perfil</a>
                        <a href="" class="d-block text-light p-3">Clases</a>
                    </div>              
                </div>
            </div>
                            ...
                            <tr>
                                <form action="eliminarClase.php" method="POST">
                                    ...
                                    <th>
                                        ...
                                        <!-------------------- Modificar --------------------->
                                        <button type="buttom" class="botonAccion" data-toggle="modal" data-target="#a"><img src="icono/modificar.png" ></img></button>
